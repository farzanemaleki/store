        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-3">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('site.blog.index')}}">همه پست ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">  دسته بندی {{$name->topic}}</li>
                </ol>
            </div><!-- End .container -->
                                    ...
                                    <div class="col-md-7">
                                        <div class="entry-body">
                                            ...
                                            <div class="entry-cats">
                                                <a href="{{route('site.blog.category.index' , $blog->id)}}">دسته بندی : {{' '.$blog->category_name($blog->category)}}</a>
                                            </div><!-- End .entry-cats -->
