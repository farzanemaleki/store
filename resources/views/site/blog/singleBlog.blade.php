            ...
            <div class="container">
                <figure class="entry-media">
                    <div class="owl-carousel owl-simple owl-light owl-nav-inside owl-rtl owl-loaded owl-drag" data-toggle="owl" data-owl-options="{&quot;rtl&quot;: true}">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(630px, 0px, 0px); transition: all 0s ease 0s; width: 2205px;"><div class="owl-item cloned" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/2.jpg" alt="توضیحات عکس"></div><div class="owl-item cloned" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/3.jpg" alt="توضیحات عکس"></div><div class="owl-item active" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/1.jpg" alt="توضیحات عکس"></div><div class="owl-item" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/2.jpg" alt="توضیحات عکس"></div><div class="owl-item" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/3.jpg" alt="توضیحات عکس"></div><div class="owl-item cloned" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/1.jpg" alt="توضیحات عکس"></div><div class="owl-item cloned" style="width: 315px;"><img src="assets/images/blog/single/fullwidth-sidebar/2.jpg" alt="توضیحات عکس"></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="icon-angle-left"></i></button><button type="button" role="presentation" class="owl-next"><i class="icon-angle-right"></i></button></div><div class="owl-dots"><button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button></div></div><!-- End .owl-carousel -->
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <article class="entry single-entry">
                            <div class="entry-body">
                                ...
                                <div class="entry-content editor-content">
                                    ...
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم لورم ایپسوم متن ساختگی با تولید
                                        سادگی نامفهوملورم ایپسوم متن ساختگی با تولید سادگی نامفهوملورم ایپسوم متن
                                        ساختگی با تولید سادگی نامفهوملورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                                        <a href="#">لورم ایپسوم</a>، لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                                    ...
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم لورم ایپسوم متن ساختگی با تولید
                                        ...
                                        ساختگی با تولید سادگی نامفهوملورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوملورم ایپسوم متن ساختگی با تولید
                                        سادگی نامفهوملورم ایپسوم متن ساختگی با تولید سادگی نامفهوم </p>
                                    ...
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم لورم ایپسوم متن ساختگی با تولید
                                        سادگی نامفهوم لورم ایپسوم متن ساختگی با تولید سادگی نامفهوملورم ایپسوم متن
                                        ساختگی با تولید سادگی نامفهوملورم ایپسوم متن ساختگی با تولید سادگی
                                        نامفهوملورم ایپسوم متن ساختگی با تولید سادگی نامفهوم <a href="#">لورم
                                            ایپسوم</a> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم لورم ایپسوم متن
                                ...
                                <div class="author-body">
                                    <div class="author-header row no-gutters flex-column flex-md-row">
                                        ...
                                        <div class="col-auto mt-1 mt-md-0">
                                            <a href="#" class="author-link">مشاهده همه پست های این نویسنده <i class="icon-long-arrow-left"></i></a>
                                        </div><!-- End .col -->
                                    </div><!-- End .row -->
                        ...
                        <div class="related-posts">
                            ...
                            <div class="owl-carousel owl-simple owl-rtl owl-loaded owl-drag" data-toggle="owl" data-owl-options="{
                                        &quot;nav&quot;: false,
                                        &quot;dots&quot;: true,
                                        &quot;margin&quot;: 20,
                                        &quot;loop&quot;: false,
                            ...
                            &quot;responsive&quot;: {
                                ...
                                <!-- End .entry -->
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1340px;"><div class="owl-item active" style="width: 315px; margin-left: 20px;"><article class="entry entry-grid">
                                                <figure class="entry-media">
                                                    <a href="single.html">
                                            ...
                                            </article></div><div class="owl-item" style="width: 315px; margin-left: 20px;"><article class="entry entry-grid">
                                                <figure class="entry-media">
                                                    <a href="single.html">
                                            ...
                                            <div class="comment">
                                                ...
                                                <div class="comment-body">
                                                    ...
                                                    <div class="comment-user">
                                                        ...
                                                        <span class="comment-date">9 فروردین 1399 - 2:19
                                                                بعدازظهر</span>
                                                    </div><!-- End .comment-user -->
